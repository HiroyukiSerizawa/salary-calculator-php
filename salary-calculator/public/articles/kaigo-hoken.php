<?php
$page_title = "介護保険料1.60%【2026年】40歳から天引きされる金額を月収別で確認";
$page_description = "2026年の介護保険料率は1.60%（本人負担0.80%）。40歳になったら月いくら増える？月収別の天引き額早見表と計算方法を解説。65歳以降の変化・第2号被保険者の仕組みもわかります。";
